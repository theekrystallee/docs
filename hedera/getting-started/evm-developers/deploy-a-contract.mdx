...
<Info>
This tutorial is currently supported only in the Getting Started [JavaScript](https://github.com/hedera-dev/hello-future-world-js) series and is not available for other languages.
</Info>
...
<Card
  ...
  icon="wallet"
  iconType="solid"
  href="https://docs.hedera.com/hedera/tutorials/more-tutorials/create-and-fund-your-hedera-testnet-account"
  horizontal
/>
...
<Card
  ...
  icon="gear"
  iconType="solid"
  href="/hedera/getting-started/environment-setup"
  horizontal
/>

<Card
  title="Configure RPC Connection (not required for Gitpod)"
  icon="plug"
  iconType="solid"
  href="https://docs.hedera.com/hedera/tutorials/more-tutorials/json-rpc-connections"
  horizontal
/>
</CardGroup>
...
In the next code walkthrough step, you can follow along or skip ahead to [Step 3](/hedera/getting-started/evm-developers/deploy-a-contract#step-3-deploy-contract-and-verify-on-hashscan-mirror-node-explorer) to execute and deploy the contract. If you decide to skip ahead, [compile the smart contract ](/hedera/getting-started/evm-developers/deploy-a-contract#compile-the-smart-contract)first.
...
Inside the `greet()` function, we want to access the `names` mapping to retrieve the name of the account calling this function. The account is identified by its [EVM account alias](https://docs.hedera.com/hedera/core-concepts/accounts/account-properties#evm-address-account-alias) and can be accessed using `msg.sender` in Solidity.

<CodeGroup>
  ```bash my_contract.sol
...
<Frame>
![](https://docs.hedera.com/~gitbook/image?url=https%3A%2F%2F72010995-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-LsUmP_7NoX2exvbv_Ps%252Fuploads%252FZy8WozBgCTo9YRS2drNQ%252Fhscs-project-directory-contract-compile.png%3Falt%3Dmedia%26token%3Df3b7b7a1-3d77-434e-85ff-7a9494b8d3fa&width=768&dpr=1&quality=100&sign=81ccd068&sv=2)
</Frame>
...
<CodeGroup>
  ```bash script-hscs-smart-contract.js
...
<Info>
If you have not configured your RPC connection to the Hedera network, do so by choosing one of the options from the [How to Connect to Hedera Networks Over RPC](https://docs.hedera.com/hedera/tutorials/more-tutorials/json-rpc-connections) tutorial before moving on to the next step. Then run `./util/04-rpcrelay-run.sh` to run a Hedera JSON-RPC relay instance.
</Info>
...
The [transaction hash](https://docs.hedera.com/hedera/support-and-community/glossary#transaction-hash) and a link to view it on HashScan will be provided in your console. See the example output [here](/hedera/getting-started/evm-developers/deploy-a-contract#step-3-deploy-contract-and-verify-on-hashscan).
...
<Frame caption="HSCS contract in Hashscan, with annotated items to check.">
  <img src="https://docs.hedera.com/~gitbook/image?url=https%3A%2F%2F72010995-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-LsUmP_7NoX2exvbv_Ps%252Fuploads%252FHPCeUseegoXRG2MEiA6v%252Fhashscan-contract-create-transaction.svg%3Falt%3Dmedia%26token%3D6577f0d9-aa1b-4912-8edf-6ab7e4e0d4aa&width=768&dpr=4&quality=100&sign=89fcfa35&sv=2" />
</Frame>
...
<CardGroup>
<Card
  title="Deploy a Smart Contract Using Hardhat and Hedera JSON-RPC Relay"
  icon="code"
  iconType="solid"
  href="https://docs.hedera.com/hedera/tutorials/smart-contracts/deploy-a-smart-contract-using-hardhat-hedera-json-rpc-relay"
/>

<Card
  title="Deploy By Leveraging Ethereum Developer Tools On Hedera"
  icon="ethereum"
  iconType="solid"
  href="https://docs.hedera.com/hedera/tutorials/smart-contracts/deploy-by-leveraging-ethereum-developer-tools-on-hedera"
  horizontal
/>
...
<Card
  ...
  icon="circle-check"
  iconType="solid"
  href="https://docs.hedera.com/hedera/tutorials/smart-contracts/how-to-verify-a-smart-contract-on-hashscan"
  horizontal
/>
</CardGroup>
